...
Read the root `AGENTS.md`, the relevant app-level `AGENTS.md`, and `docs/个人技术博客-技术方案-V1.0.0.md` before changing architecture-sensitive code.
...
5. Run the relevant typecheck/build before handing off a change. Update the V1.0.0 document only when an architectural decision changes.
