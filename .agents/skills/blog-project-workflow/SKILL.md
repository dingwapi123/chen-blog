...
Read the root `AGENTS.md`, the relevant app-level `AGENTS.md`, and `docs/个人技术博客-技术方案-V1.0.10.md` before changing architecture-sensitive code.
...
- Keep a strict 600-second Netlify Edge CDN cache with explicit headers and `Netlify-Vary: query,cookie=chen-blog-theme`; do not use numeric ISR, SWR, durable cache, or a second HTML cache layer.
