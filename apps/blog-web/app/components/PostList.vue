...
.post-list__title svg { flex: none; margin-top: 0.1em; color: var(--on-surface-faint); transition: transform 160ms ease, color 160ms ease; }
.post-list__title:hover { color: var(--accent); }
.post-list__title:hover svg { color: var(--accent); transform: translate(0.14rem, -0.14rem); }
.post-list__summary { max-width: 65ch; margin: var(--space-sm) 0 0; color: var(--on-surface-muted); }
.post-list__tags { display: flex; flex-wrap: wrap; gap: var(--space-sm); margin-top: var(--space-md); }
.post-list__tags a { color: var(--on-surface-muted); font-size: 0.82rem; }
.post-list__tags a:hover { color: var(--accent); }
.post-list__empty { margin: var(--space-xl) 0; color: var(--on-surface-muted); }
</style>
