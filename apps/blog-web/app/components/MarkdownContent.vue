...
.markdown-content :deep(pre) { overflow-x: auto; margin: 1.6em 0; padding: 1rem 1.15rem; border: 1px solid var(--border); border-radius: 0.55rem; background: var(--code-bg); font-family: var(--font-code); font-size: 0.8em; line-height: 1.7; }
