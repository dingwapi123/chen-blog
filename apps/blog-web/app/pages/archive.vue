...
.archive-heading > p:last-child { color: var(--text-muted); }
...
.archive-group h2 { margin: 0; color: var(--text-faint); font-family: var(--font-reading); font-size: clamp(2rem, 5vw, 3.4rem); font-weight: 500; letter-spacing: -0.04em; line-height: 1; }
...
.archive-group time { color: var(--text-faint); font-size: 0.78rem; }
...
.archive-group a svg { flex: none; color: var(--text-faint); transition: color 160ms ease, transform 160ms ease; }
.archive-group a:hover { color: var(--accent); }
.archive-group a:hover svg { color: var(--accent); transform: translate(0.14rem, -0.14rem); }
.archive-empty { color: var(--text-muted); }
