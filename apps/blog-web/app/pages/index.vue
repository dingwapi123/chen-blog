...
.secondary-action { color: var(--accent); background: var(--surface-high); }
.secondary-action:hover { color: var(--accent-hover); background: var(--accent-soft); }
...
.home-about { background: var(--surface-container); }.home-about__content { display: grid; grid-template-columns: minmax(0, 0.7fr) minmax(0, 1.3fr); gap: var(--space-2xl); }.home-about p { max-width: 40rem; margin: 0; color: var(--text-muted); font-size: 1.15rem; }
